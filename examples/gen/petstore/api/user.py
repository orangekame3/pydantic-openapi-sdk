...
def create_user(client: PetStore, body: Any) -> Any:
    """Create user..
...
def create_users_with_list_input(client: PetStore, body: Any) -> Any:
...
def login_user(client: PetStore, username: Optional[str] = None, password: Optional[str] = None) -> Any:
...
def get_user_by_name(client: PetStore, username: str) -> Any:
...
def update_user(client: PetStore, username: str, body: Any) -> TypedResponse:
