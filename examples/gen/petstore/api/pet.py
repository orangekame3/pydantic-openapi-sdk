...
def update_pet(client: PetStore, body: Any) -> Any:
...
def add_pet(client: PetStore, body: Any) -> Any:
...
def find_pets_by_status(client: PetStore, status: str) -> Any:
...
def find_pets_by_tags(client: PetStore, tags: List[str]) -> Any:
    """Finds Pets by tags..
...
def get_pet_by_id(client: PetStore, petId: int) -> Any:
    """Find pet by ID..
...
def update_pet_with_form(client: PetStore, petId: int, name: Optional[str] = None, status: Optional[str] = None) -> Any:
...
def upload_file(client: PetStore, petId: int, additionalMetadata: Optional[str] = None) -> Any:
    """Uploads an image..
